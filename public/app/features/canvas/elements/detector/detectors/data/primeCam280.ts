...
// I suppose ideally we should allow the user to generate they own live-detector configurations
// without modifying the source code.

// TODO: Need a layout manager to handle this.
// Use network centric approach (smallest box to contain all sensors in selected networks)
// Can also choose to view hexagons with corresponding networks but hexagon should not be required
// and networks should not be tied to viewable hexagons

export const PRIMECAM280_DETECTOR_LAYOUT: DetectorLayout = {
...
// TODO: temporary solution until revamp this to be more network oriented
// and develop a more robust layout manager.
export const PRIMECAM280_DETECTOR_LAYOUT_AL_LEFT: DetectorLayout = {
  layoutExtent: { width: 140000, height: 140000 },
  hexagons: [AL_HEXAGON_LEFT_SOLO],
}as const;

export const PRIMECAM280_DETECTOR_LAYOUT_AL_RIGHT: DetectorLayout = {
  layoutExtent: { width: 140000, height: 140000 },
  hexagons: [AL_HEXAGON_RIGHT_SOLO],
}as const;

export const PRIMECAM280_DETECTOR_LAYOUT_TIN: DetectorLayout = {
  layoutExtent: { width: 140000, height: 140000 },
  hexagons: [TIN_HEXAGON_SOLO],
}as const;
